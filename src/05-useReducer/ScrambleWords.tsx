...
import { getTasksInitialState } from "./reducer/tasksReducer";
import {
  getInitialState,
...
export const ScrambleWords = () => {
  ...
  const handleGuessSubmit = (e: React.FormEvent) => {
    ...
    e.preventDefault();
    dispacth({ type: "CHECK_ANSWER" });
  };

  const handleSkip = () => {
    dispacth({ type: "SKIP_WORD" });
  };

  const handlePlayAgain = () => {
    dispacth({ type: "STAR_NEW-GAME", payload: getInitialState() });
  };
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      dispacth({ type: "SET_GUESS", payload: e.target.value });
                    }}
